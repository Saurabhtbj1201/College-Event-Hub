...
This project is being actively built and refined for **PromptWars: Virtual**.

- Tagline: **Build, deploy and win from anywhere**
- Region: **India only**
- Format: **Bi-weekly virtual hackathon**
- Approach: **Intent-driven development using Google Antigravity**

Official event page: https://promptwars.in/promptwarsVirtual.html

### How The 14-Day Cycle Works

| Phase | Timeline | What Happens |
|---|---|---|
| Challenge Release | Day 1 (Monday) | A real-world challenge is released for Beginner, Intermediate, and Advanced builders. |
| Building Phase | Day 1 to Day 12 | Build a functional app with Google Antigravity using prompt-first workflows. |
| Submission Phase | By Day 13 | Submit technical artifacts (code + live preview) and narrative artifacts (blog + LinkedIn build-in-public post). |
| Evaluation and Announcement | Day 14 | Experts review valid submissions; leaderboard and Prompt Credits are updated. |

### Event-Focused Build Goals For This Repository

- Deliver a production-style smart campus event operations platform.
- Demonstrate strong real-time capabilities with measurable quality gates.
- Showcase build-in-public engineering discipline through clean docs and phased delivery.
